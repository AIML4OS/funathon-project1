...
You have to load the file `2026/project1/data/transactions_EN.parquet` for transactions.
...
# We load all transactions made in France between 2010 and 2022
trans = pd.read_parquet('s3://projet-funathon/2026/project1/data/transactions_EN.parquet')
```
:::
